...
const classes = {
  ...
  iconExpand: "absolute right-3 top-1/2 -translate-y-1/2 transition-transform duration-300 pointer-events-none",
  iconClear: "absolute right-9 top-1/2 -translate-y-1/2 cursor-pointer",
